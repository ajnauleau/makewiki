...
class Page(models.Model):
    ...
    slug = models.CharField(max_length=settings.WIKI_PAGE_TITLE_MAX_LENGTH, blank=True,
                            help_text="Unique URL path to access this page. Generated by the system.")
    email = models.EmailField(max_length=settings.WIKI_PAGE_TITLE_MAX_LENGTH, default="email@web.com",
                            help_text="Email")
